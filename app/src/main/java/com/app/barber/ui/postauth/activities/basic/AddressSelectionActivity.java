...
public class AddressSelectionActivity extends BaseActivity implements BasicAuthMVPView, LocationListener {
                ...
                try {
                    if (location != null) {
                        ...
                        if (location != null) {
                            ...
                            Log.e("onSuccess", " get " + new Gson().toJson(mPref.getLocation()));
                        }
                    }
                } catch (Exception e) {
                    e.printStackTrace();
    ...
    @OnClick({R.id.btn_current_loctaion, R.id.btn_postcode_loctaion, R.id.btn_enter_manually})
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == GlobalValues.RequestCodes.LOCATION_PICKER)
            if (resultCode == RESULT_OK) {
                ...
                new GetLocationFromLatLong(AddressSelectionActivity.this, latitude, longitude,
