...
public class AddServiceActivity extends BaseActivity implements BasicAuthMVPView {
    ...
    String[] priseTypes = {"Fixed", "Not Fixed"};
    ...
    private void initSpiner() {
        ...
        ArrayAdapter aa = new ArrayAdapter(this, R.layout.custom_text_layout, priseTypes);
        aa.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        //Setting the ArrayAdapter data on the Spinner
        priceType.setAdapter(aa);
    }
        ...
        switch (view.getId()) {
            ...
            case R.id.continue_btn:
                if (validated()) {
                    ...
                    addModel.setDuration(Integer.parseInt(edtxtDuration.getText().toString()));
                    addModel.setPrice(edtxtPrice.getText().toString());
                    addModel.setPriceType(priceType.getSelectedItem().toString());
                    if (isEdit)
